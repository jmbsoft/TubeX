    ...
    <div class="main-content page-content">
      <span class="section-left">
        ...
        <div class="header">
          ...
          <span class="header-text">{"_Text:Modify Your Avatar"}</span>
        </div>
          ...
          <form method="post" action="{$g_config.base_uri}/user.php?r=avatar" enctype="multipart/form-data">
            ...
            <div class="field">
              ...
              <span class="input-container" style="width: 50%">
                ...
                <span class="fs80">{"_Text:Avatar restriction",$g_config.avatar_dimensions,$g_config.avatar_filesize,$g_config.avatar_extensions}</span>
              </span>
            </div>

        ...
        <div class="section-content section-videos">
          ...
          <span class="video">
            <div class="video-container">
              <a href="{$g_config.base_uri}/index.php?r=category&amp;c={$category.url_name|urlencode}">
                <img src="{if $category.uri}{$category.uri}{else}{$g_config.no_preview}{/if}" class="video-thumb" title="{$category.name}" />
              </a>
              <div class="text-center">
                <a href="{$g_config.base_uri}/index.php?r=category&amp;c={$category.url_name|urlencode}" class="fs110">{$category.name}</a> <span class="fs90" style="color: #999;">({$category.num_videos})</span><br />
              </div>
            </div>
          </span>
          {/foreach}

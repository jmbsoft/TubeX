    ...
    <div class="main-content" style="padding-top: 20px;">
      ...
      <div id="main-header">
        ...
        <span class="links">
          ...
          <span class="dot"></span>
          <a href="{$g_config.base_uri}/index.php?r=videos-newest">{"_Text:Newest Videos"}</a>
          <span class="dot"></span>
          <a href="{$g_config.base_uri}/index.php?r=videos">{"_Text:Browse Videos"}</a>
          <span class="dot"></span>
          <a href="{$g_config.base_uri}/index.php?r=categories">{"_Text:Categories"}</a>
        </span>

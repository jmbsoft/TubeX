      ...
      <span class="section-left">
        ...
        <div class="section-content">
          <div class="header">
            ...
            <span class="header-text">{"_Text:Update A Video"}</span>
          </div>
          ...
          <form method="post" action="{$g_config.base_uri}/user.php?r=video-edit">
            ...
            <div class="field">
              ...
              <span class="input-container" style="width: 70%;">
                ...
                {else}
                <span class="fs80">{"_Text:Select thumbnail"}</span>

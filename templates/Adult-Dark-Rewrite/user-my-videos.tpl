        ...
        <div class="section-content">
          ...
          <div class="video-brief" id="video-{$video.video_id}">
            ...
            <span class="video-brief-details">
              {if $video.is_private}
              <a href="{$g_config.base_uri}/private/{$video.video_id}/{$video.private_id}/" class="fs110">
              {else}
              <a href="{$g_config.base_uri}/video/{$video.video_id}/{$video.title|t_urlify(5)}" class="fs110">
              {/if}
              {$video.title}</a><br />

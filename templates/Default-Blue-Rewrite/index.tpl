        ...
        <div class="section-content horizontal-layout" style="padding: 15px; padding-bottom: 0;">
          ...
          <span>
            <div class="video-container">
              ...
              <a href="{$g_config.base_uri}/video/{$video.video_id}/{$video.title|t_urlify(5)}" title="{$video.title}">{$video.title|t_chop(30,'...')}</a>
            </div>
          </span>
          {/foreach}
          ...
          <div class="video-brief">
            ...
            <span class="video-brief-details">
              ...
              <div class="video-brief-facets smallest">
                ...
                <span><a href="{$g_config.base_uri}/profile/{$video.username}/" class="normal">{$video.username}</a></span>
              </div>
            </span>
          </div>
          {/foreach}

  ...
  <body>
    ...
    <div class="main-content">
      ...
      <div id="navigation-tabs" class="center">
        ...
        <a {if !$g_loc_newest}href="{$g_config.base_uri}/videos/newest/"{/if}>{"_Text:Newest Videos"}</a>
        <a {if !$g_loc_videos}href="{$g_config.base_uri}/videos/"{/if}>{"_Text:Browse Videos"}</a>
        <a {if !$g_loc_categories}href="{$g_config.base_uri}/categories/"{/if}>{"_Text:Categories"}</a>
        {nocache}
        {if $g_logged_in}

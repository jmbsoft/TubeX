    ...
    <div class="main-content" style="margin-top: 30px;">
      ...
      <div class="section-content">
        ...
        <span style="display: inline-block; width: 45%; margin: 10px;">
          ...
          {"_Text:No Account"} <a href="{$g_config.base_uri}/user/register/">{"_Text:Signup Now"}</a>
        </span>

        <span style="display: inline-block; vertical-align: top; margin: 10px;">
          <form action="{$g_config.base_uri}/user/login/" method="post">
            ...
            <div class="field">
              <span class="label">{"_Label:Password"}:</span> <input type="password" name="password" size="20" /> <a href="{$g_config.base_uri}/user/reset/" class="smallest">Lost Password?</a>
            </div>

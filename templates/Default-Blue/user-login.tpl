      ...
      <div class="section-content">
        ...
        <span style="display: inline-block; vertical-align: top; margin: 10px;">
          <form action="{$g_config.base_uri}/user.php?r=login" method="post">
            ...
            <div class="field">
              <span class="label">{"_Label:Password"}:</span> <input type="password" name="password" size="20" /> <a href="{$g_config.base_uri}/user.php?r=reset" class="smallest">Lost Password?</a>
            </div>

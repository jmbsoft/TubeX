    ...
    {else}
      <span class="section-left">
        ...
        <div class="section-content">
          ...
          {* <iframe src="{$g_config.base_uri}/index.php?r=video-comments&amp;d=iframe&amp;id={$video.video_id}" class="comments-iframe" frameborder="0"></iframe> *}
      ...
      <span class="section-right">
        ...
        <div class="section-content">
          ...
          <span style="display: inline-block; vertical-align: top;">
            {if $user}<a href="{$g_config.base_uri}/index.php?r=profile&amp;u={$video.username|urlencode}">{$video.username}</a><br />{/if}
          ...
          <div class="small" style="border-top: 1px solid #afafaf; padding: 4px 2px;">
            <div style="margin-top: 3px;">
              ...
              <input type="text" size="30" class="small" style="width: 200px;" value="{$g_config.base_url}/index.php?r=video&amp;id={$video.video_id}" /><br />
            </div>
        ...
        <div class="section-content">
          ...
          <div class="video-brief">
            ...
            <span class="video-brief-details" class="small" style="width: 58%;">
              <a href="{$g_config.base_uri}/index.php?r=video&amp;id={$v.video_id}" class="small">{$v.title|t_chop(30,'...')}</a>
          ...
          <div class="video-brief">
            ...
            <span class="video-brief-details" class="small" style="width: 58%;">
              ...
              <div class="video-brief-facets smallest">
                ...
                <span><a href="{$g_config.base_uri}/index.php?r=profile&amp;u={$v.username|urlencode}" class="normal">{$v.username}</a></span>
              </div>
            </span>
          </div>
          {/foreach}

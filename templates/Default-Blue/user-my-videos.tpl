        ...
        <div class="section-content">
          ...
          <div class="video-brief" id="video-{$video.video_id}">
            ...
            <span class="video-brief-details">
              {if $video.is_private}
              <a href="{$g_config.base_uri}/index.php?r=private&amp;id={$video.video_id|urlencode}&amp;pid={$video.private_id|urlencode}" class="large">
              {else}
              <a href="{$g_config.base_uri}/index.php?r=video&amp;id={$video.video_id}" class="large">
              {/if}
              {$video.title}</a><br />

      ...
      <span class="section-left">
        ...
        <div class="section-content">
          ...
          <div class="video-brief" id="favorite-{$video.video_id}">
            ...
            <span class="video-brief-details">
              ...
              <div class="video-brief-facets smallest">
                ...
                <span><a href="{$g_config.base_uri}/user.php?r=favorite-remove&amp;video_id={$video.video_id}" class="favorite-remove" videoid="{$video.video_id}">{"_Text:Remove"}</a></span>
              </div>
          ...
          <div class="pagination">
            {template file="global-pagination.tpl" uri="user.php?r=favorites&p="}
          </div>

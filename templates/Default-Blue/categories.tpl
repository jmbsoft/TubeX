    ...
    <div class="main-content" style="margin-top: 30px;">
      <span class="section-left">
        ...
        <div class="section-content">
          ...
          <a href="{$g_config.base_uri}/index.php?r=category&amp;c={$category.url_name|urlencode}">{$category.name}</a> <span class="small" style="color: #999;">({$category.num_videos})</span><br />

...
$(function()
{
    ...
    <div class="main-content" style="margin-top: 30px;">
      <span class="section-whole">
        ...
        <div class="section-header">{"_Text:Create an Account"}</div>
        <div class="section-content">
          ...
          <form method="post" action="{$g_config.base_uri}/user.php?r=register">

            <div class="field">
              <span class="label wider">{"_Label:Username"}:</span>
              <span class="input-container">
                <input type="text" name="username" size="30" value="{$g_form.username}" /><br />
                <span class="smallest">{"_Text:Username restriction"}</span>
              </span>
            </div>
            ...
            <div class="field">
              ...
              <span class="input-container">
                ...
                <span class="smallest">{"_Text:Password restriction"}</span>
              </span>
            </div>

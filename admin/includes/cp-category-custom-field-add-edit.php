    <div id="dialog-header" class="ui-widget-header ui-corner-all">
      ...
      <?php echo (isset($editing) ? 'Update a Custom Category Field' : 'Add a Custom Category Field'); ?>
    </div>
    ...
    <form method="post" action="ajax.php">
      <div id="dialog-panel">
        <div style="padding: 8px;">
          ...
          <div id="dialog-help">
            <a href="docs/cp-category-custom-field.html" target="_blank"><img src="images/help-22x22.png" alt="Help" title="Help" border="0" /></a>
          </div>
      ...
      <div id="dialog-buttons">
        ...
        <input type="submit" id="button-save" value="<?php echo (isset($editing) ? 'Save Changes' : 'Add Custom Category Field') ?>" />
        <input type="button" id="dialog-button-cancel" value="Cancel" style="margin-left: 10px;" />
      </div>

      <input type="hidden" name="r" value="<?php echo (isset($editing) ? 'tbxGenericEdit' : 'tbxGenericAdd') ?>(category-custom-field)" />

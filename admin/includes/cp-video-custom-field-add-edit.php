    <div id="dialog-header" class="ui-widget-header ui-corner-all">
      ...
      <?php echo (isset($editing) ? 'Update a Custom Video Field' : 'Add a Custom Video Field'); ?>
    </div>
    ...
    <form method="post" action="ajax.php">
      <div id="dialog-panel">
        <div style="padding: 8px;">
          ...
          <div id="dialog-help">
            <a href="docs/cp-video-custom-field.html" target="_blank"><img src="images/help-22x22.png" alt="Help" title="Help" border="0" /></a>
          </div>
          ...
          <div class="field">
            ...
            <span class="field-container">
              <div class="checkbox">
                <input type="hidden" name="on_submit" value="<?php echo Request::Get('on_submit'); ?>" />
          ...
          <div class="field">
            ...
            <span class="field-container">
              <div class="checkbox">
                <input type="hidden" name="on_edit" value="<?php echo Request::Get('on_edit'); ?>" />
                Display on editing form
              </div>
            </span>
          </div>
      ...
      <div id="dialog-buttons">
        ...
        <input type="submit" id="button-save" value="<?php echo (isset($editing) ? 'Save Changes' : 'Add Custom Video Field') ?>" />
        <input type="button" id="dialog-button-cancel" value="Cancel" style="margin-left: 10px;" />
      </div>

      <input type="hidden" name="r" value="<?php echo (isset($editing) ? 'tbxGenericEdit' : 'tbxGenericAdd') ?>(video-custom-field)" />

    ...
    <div id="dialog-panel">
      <div style="padding: 8px;">
        ...
        <?php include_once('cp-conversion-queue-stats.php'); ?>
...
$(function()
{
    var cqinterval = setInterval(function()
                                {
                                    $('#cq-updating').show();
                                    $('#dialog-panel > div').load('ajax.php', {r: 'tbxConversionQueueStats'}, function() { $('#cq-updating').hide(); });
                                },
                                5000);
    ...
    .click(function()
           {
               ...
               $.ajax({data: 'r=tbxConversionQueueStart'});
           });

    $('#dialog-button-stop')
    .click(function()
           {
               $.ajax({data: 'r=tbxConversionQueueStop'});
           });

    $('#dialog-button-clear')
    .click(function()
           {
               $.ajax({data: 'r=tbxConversionQueueClear'});
           });
});
</script>
